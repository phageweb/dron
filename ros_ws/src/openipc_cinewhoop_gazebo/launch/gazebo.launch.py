...
def generate_launch_description():
    ...
    world_path = os.path.join(pkg_share, "worlds", "indoor_test.sdf")
    ...
    return LaunchDescription([
        ...
        SetEnvironmentVariable(
            ...
            [models_path, ":", os.path.join(pkg_share, "worlds"), ":", EnvironmentVariable("GZ_SIM_RESOURCE_PATH", default_value="")],
        ),
        SetEnvironmentVariable(
            "SDF_PATH",
